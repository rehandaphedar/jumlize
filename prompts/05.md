...
*   **Handling Quoted Text:**
    ...
    *   VERIFY: If the input contains a closing `"`, your output MUST contain it in the last segment.
	*   Any quotation marks (") within the input are part of the text content and must be preserved.
